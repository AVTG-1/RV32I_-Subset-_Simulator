...
memory_returns memory_access(execute_returns execute_ans)
{
    ...
    {   
        ...
        if(rregno_rd<0){
            ...
            memory_returns te = memory_returns();
            return te;
        }
...
{ //if (rregno_rd >= 268435456 && rregno_rd < 268441456)
    ...
    // r[3] = 268435456; r[5] = 268435484; r[7] = 268435472; r[9] = 268435480; r[22] = 268435488; r[24] = 268435492; r[26] = 268435500; r[28] = 268435520;
    // r[6]=42;
    //r[10]=5;
    ifstream f;
    string l;
    ...
    execute_returns execute_ans;
    memory_returns memory_ans;
    f.open("bubblesort.mc");
    while (!f.eof())
    {
        getline(f, l);
        if (l == "" || l.find("TEXT SEGMENT") != string::npos)
            continue;

       // Ignore anything after the first comma
       size_t comma_pos = l.find(",");
       if (comma_pos != string::npos)
           l = l.substr(0, comma_pos);
        ...
        ss >> pcn;
// Add "0x" prefix manually if missing
string inst = (pcn.find("0x") == 0) ? pcn.substr(2) : pcn;
